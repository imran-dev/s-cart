                ...
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <div class="btn-group pull-right" style="margin-right: 5px">
                            <a href="{{ route('admin_category.index') }}" class="btn  btn-flat btn-default"
                    ...
                    <div class="box-body">
                        <div class="fields-group">
                            ...
                            @foreach ($languages as $code => $language)
                                ...
                                <div class="form-group   {{ $errors->has('descriptions.'.$code.'.keyword') ? ' has-error' : '' }}">
                                    <label for="{{ $code }}__keyword"
                                           class="col-sm-2  control-label">{{ trans('category.keyword') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                                ...
                                <div class="form-group   {{ $errors->has('descriptions.'.$code.'.description') ? ' has-error' : '' }}">
                                    <label for="{{ $code }}__description"
                                           class="col-sm-2  control-label">{{ trans('category.description') }}</label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                            ...
                            <div class="form-group   {{ $errors->has('image') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <div id="preview_image" class="img_holder"><img
                                                src="{{ old('image',$category['image']??'') }}"></div>
                                </div>
                            </div>
                            ...
                            <div class="form-group  ">
                                ...
                                <div class="col-sm-8">
                                    <input type="checkbox"
                                           name="top" {{ old('top',(empty($category['top'])?0:1))?'checked':''}}>
                                </div>
                            </div>

                            <div class="form-group  ">
                                <label for="status"
                                       class="col-sm-2  control-label">{{ trans('category.status') }}</label>
                                <div class="col-sm-8">
                                    <input type="checkbox"
                                           name="status" {{ old('status',(empty($category['status'])?0:1))?'checked':''}}>
