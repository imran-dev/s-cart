    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            $dataTr[] = [
                ...
                'action' => '
                    <a href="' . route('admin_discount.edit', ['id' => $row['id']]) . '"><span title="' . trans('Extensions/Total/Discount.admin.edit') . '" type="button" class="btn btn-flat btn-primary btn-xs"><i class="fa fa-edit"></i></span></a>&nbsp;

                  <span onclick="deleteItem(' . $row['id'] . ');"  title="' . trans('Extensions/Total/Discount.admin.delete') . '" class="btn btn-flat btn-danger btn-xs"><i class="fa fa-trash"></i></span>
                  ',
            ];
        }
