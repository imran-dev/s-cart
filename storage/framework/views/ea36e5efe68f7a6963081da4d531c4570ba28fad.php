...
<!--//Module top footer -->
  ...
  <footer id="footer"><!--Footer-->
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          <p class="pull-left">Copyright © <?php echo e(date('Y')); ?> <a href="<?php echo e(config('scart.homepage')); ?>"><?php echo e(config('scart.name')); ?> <?php echo e(config('scart.version')); ?></a> Inc. All rights reserved.</p>
...
<!--//Footer-->
<?php /**PATH E:\laragon\www\anytimebazar\resources\views/templates/default/footer.blade.php ENDPATH**/ ?>