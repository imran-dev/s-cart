...
<div class="row">
  ...
  <div class="col-md-6">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo e(trans('store_value.admin.config_mode')); ?></h3>
      ...
      <div class="box-body table-responsive no-padding box-primary">
       <table class="table table-hover">
         <thead>
           <tr>
             <th><?php echo e(trans('store_value.admin.field')); ?></th>
             <th><?php echo e(trans('store_value.admin.value')); ?></th>
           </tr>
         </thead>
         <tbody>
           <?php $__currentLoopData = $configs['config']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <tr>
  ...
  <div class="col-md-6">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title"><?php echo e(trans('store_value.admin.config_display')); ?></h3>
      ...
      <div class="box-body table-responsive no-padding box-primary">
       <table class="table table-hover">
         <thead>
           <tr>
             <th width="40%"><?php echo e(trans('store_value.admin.field')); ?></th>
             <th><?php echo e(trans('store_value.admin.value')); ?></th>
           </tr>
         </thead>
         <tbody>
           <?php $__currentLoopData = $configs['display']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $config): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <tr>
               <td><?php echo e(sc_language_render($config->detail)); ?></td>
...
<?php echo $__env->make('admin.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laragon\www\anytimebazar\resources\views/admin/screen/store_value.blade.php ENDPATH**/ ?>