...
(function( $ ){
      ...
      $.fn.filemanager = function(type, options) {
        ...
        this.on('click', function(e) {
          ...
          var route_prefix = (options && options.prefix) ? options.prefix : '/<?php echo e(config('lfm.url_prefix')); ?>';
...
// active tree menu
$(function(){
    // var route_name = '<?php echo e(request()->route()->getName()); ?>';
...
<?php /**PATH E:\laragon\www\anytimebazar\resources\views/admin/component/script.blade.php ENDPATH**/ ?>